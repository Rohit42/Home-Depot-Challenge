...
def load_data():
    X_train = []
    Y_train = []
    wordsToNums = {'Chandeliers':0, 'Showerheads':1, 'Ceiling Fans':2, 'Vanity Lighting':3, 'Floor Lamps':4, 'Single Handle Bathroom Sink Faucets':5}
    numsToWords = {0: 'Chandeliers', 1: 'Showerheads', 2: 'Ceiling Fans', 3: 'Vanity Lighting', 4: 'Floor Lamps', 5: 'Single Handle Bathroom Sink Faucets'}
    idToCat = {}
